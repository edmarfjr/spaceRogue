...
class DeixarBomba extends Ability {
  const DeixarBomba(): super(nome: 'Deixar Bomba', descricao: 'Deixa uma bomba no chão — consome o estoque do treinador.', cooldown: 1, custoEnergia: 2.5, target: AbilityTarget.plrDir);
